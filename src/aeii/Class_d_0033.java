...
public class Class_d_0033 {
	...
	public Class_d_0033(String id, int paramInt1, int paramInt2) {
		this.var_699 = false;
		this.var_6d1 = 0;
		byte[] bytes = Class_c_MainCanvas.getResourceString(id + ".png");
		this.var_691 = sub_710(Image.createImage(bytes, 0, bytes.length), paramInt1, -1, true);
	...
	public static Image sub_710(Image paramImage, int paramInt1, int paramInt2, boolean paramBoolean) {
		if (paramImage == null) {
			return null;
		}
		try {
			...
			if (bool1 == 1) {
				...
				sub_97e(arrayOfInt1, arrayOfInt2, width, i, paramInt1, paramInt2, true);
				return Image
						.createRGBImage(arrayOfInt2, paramInt1, paramInt2, true);
			}
			Image image;
			...
			for (int j = 0; j < bool1; j++) {
				for (i = 0; i < bool1; i++) {
					paramImage
							.getRGB(arrayOfInt1, 0, bool2, j * bool2, i * bool3, bool2, bool3);
					sub_97e(arrayOfInt1, arrayOfInt2, bool2, bool3, bool4, bool5, false);
					gr.drawRGB(arrayOfInt2, 0, bool4, j * bool4, i * bool5, bool4, bool5, false);
				}
			}
			return image;
	...
	public void sub_1139(Graphics paramGraphics, int paramInt1, int paramInt2, int paramInt3) {
		if ((!this.var_699) && (this.var_6d1 == 0)) {
			paramGraphics
					.drawImage(this.var_691, paramInt1 + this.var_6c1, paramInt2 + this.var_6c9, paramInt3);
			return;
		}
		paramGraphics
				.drawRegion(this.var_691, this.var_6a1, this.var_6a9, this.var_6b1, this.var_6b9, this.var_6d1, paramInt1 + this.var_6c1, paramInt2 + this.var_6c9, paramInt3);
	}

	public Image sub_11ba() {
		return Image
				.createImage(this.var_691, this.var_6a1, this.var_6a9, this.var_6b1, this.var_6b9, this.var_6d1);
	}
	...
	public Class_d_0033(String paramString, int paramInt) {
		...
		if (paramInt != 1) {
			arrayOfByte = Class_c_MainCanvas
					.getResourceString(Class_g_1956.var_4682[paramInt] + "_" + paramString + ".png");
		}
		if (arrayOfByte == null) {
			arrayOfByte = Class_c_MainCanvas
					.getResourceString(paramString + ".png");
		}
